...
totals = [prices[i] * quantities[i] for i in range(len(prices))]

# TODO: Filter totals above 30
high_totals = [total for total in totals if total > 30]

# TODO: Pair prices and quantities with zip()
pairs = [[prices[i], quantities[i]] for i in range(len(prices))]
